    ...
    public void FreshHUD()
    {
        if(Init.me.GetComponent<RoleData>().data!=null)
        {
            ...
            if(olde!=Init.me.GetComponent<RoleData>().data.exp)
            {
                ...
                exp_rect.sizeDelta = new Vector2(( (float)Init.me.GetComponent<RoleData>().data.exp/Role.LevelExp[Init.me.GetComponent<RoleData>().data.level])*exp_img_width,exp_rect.rect.height);
            }
        }
    }
}
